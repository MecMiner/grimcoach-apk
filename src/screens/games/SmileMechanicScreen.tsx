...
const SMILE_STRICT_THRESHOLD = 0.85; // Limiar rigoroso para não pegar qualquer sorriso
...
const COMMANDS: SimonCommandConfig[] = [
  {
    ...
    instruction: 'Dê um SORRISÃO bem aberto para a câmera!',
    icon: 'happy',
    hintEmoji: '😁',
  },
  {
  ...
  },
  {
    ...
    title: 'O Chefinho Mandou:',
    instruction: 'Sorria com vontade E pisque o olho esquerdo!',
    icon: 'sparkles',
    hintEmoji: '😜😁',
  },
  {
    ...
    title: 'O Chefinho Mandou:',
    instruction: 'Sorria com vontade E pisque o olho direito!',
    icon: 'sparkles',
    hintEmoji: '😉😁',
  },
];
  ...
  const handleFacesDetected = useCallback(
    (faces: Face[]) => {
      ...
      try {
        ...
        const closedThreshold = 0.38;
        const openThreshold = 0.65;

        // Validação rigorosa de sorriso
        const isSmiling = smileProb >= SMILE_STRICT_THRESHOLD;
      ...
      <View style={styles.container}>
        ...
        <View style={styles.mirrorWrapper}>
          <CameraStream
            ...
            feedbackText="Perfeito! Segure o sorrisão..."
          />
        ...
        <TutorialVideoModal
          ...
          instructionText="Fique atento ao que o Chefinho mandar! Mostre um sorrisão aberto, pisque um dos olhos ou faça as duas coisas juntas e segure a pose até a validação!"
